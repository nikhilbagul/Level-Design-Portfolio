...
namespace UnityStandardAssets.Utility
{
    public class WaypointCircuit : MonoBehaviour
    {
        ...
        public Transform[] Waypoints                  //Waypoints[] is a property that converts waypointList's array-Items to Waypoint's array values automatically
        {
        ...
        public class WaypointList
        {
            ...
            public Transform[] items = new Transform[0];           // Why??
        }
